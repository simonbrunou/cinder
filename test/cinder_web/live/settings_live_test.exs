defmodule CinderWeb.SettingsLiveTest do
  ...
  test "renders the grouped settings form", %{conn: conn} do
    ...
    assert has_element?(lv, "#ebooks_library_path[name=ebooks_library_path]")
    ...
    refute has_element?(lv, "#ebooks_anime_library_path")
    refute has_element?(lv, "#ebooks_min_size")
    refute has_element?(lv, "#ebooks_preferred_resolutions")
    refute has_element?(lv, "#ebooks_upgrade_cutoff")
    refute has_element?(lv, "#ebooks_plex_section")
