...
it — it never guesses. (Post-A5, issue #123 sanctioned one narrow exception: a batch of exactly one
...
issue #123: a lone unparseable file against a lone reserved episode is inferred instead of held.)
