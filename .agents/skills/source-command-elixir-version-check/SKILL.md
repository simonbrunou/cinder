---
name: "source-command-elixir-version-check"
description: "Check current Elixir/OTP versions and project requirements"
---

# source-command-elixir-version-check

Use this skill when the user asks to run the migrated source command `elixir-version-check`.
