defmodule Cinder.Jobs do
  ...
  `/activity` (series metadata refresh, subtitle backfill, Plex watchlist sync). `statuses/0` gives the activity view a
  ...
  """
  @workers [Cinder.Catalog.Refresher, Cinder.Subtitles.Sweeper, Cinder.Requests.WatchlistSync]
