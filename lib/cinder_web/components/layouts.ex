defmodule CinderWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <div :if={@signed_in?} class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex min-h-screen flex-col">
        ...
        <main
          id="main"
          class="mx-auto w-full max-w-6xl flex-1 px-4 py-8 pb-20 sm:px-6 lg:px-8 2xl:max-w-[110rem]"
        >
  ...
  def theme_toggle(assigns) do
    ...
    <div
      ...
      phx-update="ignore"
      class="card relative flex w-32 flex-row items-center border-2 border-base-300 bg-base-300 rounded-full"
    >
