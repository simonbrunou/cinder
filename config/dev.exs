...
config :cinder, CinderWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "P1D2/XRljJItlFvVKaO9jmuNJXYKhEXFQdryr/12lucZj3iShtsNEM7a+68V6FuI",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:cinder, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:cinder, ~w(--watch)]}
  ]
...
config :cinder, CinderWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/cinder_web/router\.ex$"E,
      ~r"lib/cinder_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
